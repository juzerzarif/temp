...
import com.cerner.cura.device_association.legacy.ui.AssociationEditFragment;
import com.cerner.cura.device_association.legacy.ui.AssociationSummaryFragment;
import com.cerner.cura.device_association.legacy.ui.ItemDetailsDeviceAssociationFragment;
import com.cerner.cura.device_association.legacy.ui.ModifyDateTimeFragment;
...
/**
 * Tests for charting navigator activity class.
 *
 * @author Charlotte Clark (cc035054).
 */
@RunWith(RobolectricTestRunner.class)
public class ChartingNavigatorActivityTests {
    private ActivityController<ChartingNavigatorActivity> mActivityController;
    private ChartingNavigatorActivity mMockActivity;
    ...
    public void setup() {
        ...
        mActivityController = Robolectric.buildActivity(ChartingNavigatorActivity.class).create().postCreate(null);
    ...
    public void onCreate_closeDrawer() {
        ...
        TestUtils.setVariable(mMockActivity, "mCurrentFragment", AssociationEditFragment.class);
        Mockito.doReturn(actionBar).when(mMockActivity).getActionBar();
        final AssociationEditFragment associationEditFragment = Mockito.mock(AssociationEditFragment.class);
        Mockito.doReturn(fragmentManager).when(mMockActivity).getFragmentManager();
        Mockito.doReturn(associationEditFragment).when(fragmentManager).findFragmentById(mViewToReplace);
        toggle.onDrawerClosed(null);
